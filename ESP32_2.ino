...
#define EAP_IDENTITY "dimas.anhar@mhs.unsod.ac.id"
#define EAP_USERNAME "dimas.anhar@mhs.unsod.ac.id"
...
const bool POT_STEP_HIGHER_MEANS_HIGHER_SPEED = true;
...
const int LM35_SAMPLE_COUNT = 20;
